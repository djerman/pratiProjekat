...
/**
 * DTO за ентитет DdVozaciLicence.
 * Представља лиценцу возача.
 */
public class DdVozaciLicenceDto extends BaseDto {
    ...
    /** Орган који је издао лиценцу */
    private String izdao;

    /** Датум издавања */
    private LocalDate izdato;

    /** Датум до када важи лиценца */

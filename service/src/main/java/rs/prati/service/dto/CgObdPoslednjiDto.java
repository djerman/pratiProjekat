...
/**
 * DTO за ентитет CgObdPoslednji.
 * Представља последње познате OBD податке за објекат (возило/уређај).
 */
public class CgObdPoslednjiDto extends BaseDto {

    /** ID објекта (уређаја/возила) */

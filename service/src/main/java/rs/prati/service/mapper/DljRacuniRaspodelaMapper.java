...
/**
 * MapStruct мапер за ентитет DljRacuniRaspodela и његов DTO.
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface DljRacuniRaspodelaMapper extends EntityMapper<DljRacuniRaspodela, DljRacuniRaspodelaDto> {
    ...
    DljRacuniRaspodelaDto toDto(DljRacuniRaspodela entity);
    ...
    DljRacuniRaspodela toEntity(DljRacuniRaspodelaDto dto);

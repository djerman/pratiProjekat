...
/**
 * MapStruct мапер за ентитет DlSifre и његов DTO.
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface DlSifreMapper extends EntityMapper<DlSifre, DlSifreDto> {
    ...
    DlSifreDto toDto(DlSifre entity);
    ...
    DlSifre toEntity(DlSifreDto dto);

...
/**
 * MapStruct мапер за ентитет DdVozaciLicence и његов DTO.
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface DdVozaciLicenceMapper extends EntityMapper<DdVozaciLicence, DdVozaciLicenceDto> {
    ...
    DdVozaciLicenceDto toDto(DdVozaciLicence entity);
    ...
    DdVozaciLicence toEntity(DdVozaciLicenceDto dto);
